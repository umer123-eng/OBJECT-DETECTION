...
def apply_erosion(frame, kernel_size=(5, 5), iterations=1):
...
while True:
    ...
    # Apply erosion
    eroded_frame = apply_erosion(thresholded_frame)

    # Resize frames
    frame_resized = rescaleframe(frame)
    eroded_frame_resized = rescaleframe(eroded_frame)
    ...
    cv2.imshow('Resized Eroded Video', eroded_frame_resized)
